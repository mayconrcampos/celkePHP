...
function sendEmail($user){
    ...
    // Email destino
    $Mailer->addAddress("$user", "Aplicativo de Controle Financeiro");
    ...
    // Corpo da mensagem
    $Mailer->Body = "<h1>Ative já sua conta e tenha total controle sobre sua vida financeira</h1><a href='http://localhost/celkePHP/02%20-%20MySQLi%20e%20PHP/Controle%20de%20Financas/ativa.php?usuario=".$user."'>Clique aqui pra confirmar sua conta no Sistema de Cadastro de Clientes</a>";
