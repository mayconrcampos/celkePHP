...
function sendEmail($user){
    ...
    // Email destino
    $Mailer->addAddress("$user", "Sistema de Cadastro de Clientes");
    ...
    // Corpo da mensagem
    $Mailer->Body = "<a href='http://localhost/celkePHP/02%20-%20MySQLi%20e%20PHP/18%20-%20CRUD/ativa.php?usuario=".$user."'>Clique aqui pra confirmar sua conta no Sistema de Cadastro de Clientes</a>";
...
/// Função de mandar email via GET
    ...
    // Corpo da mensagem
    $Mailer->Body = "<a href='http://localhost/celkePHP/02%20-%20MySQLi%20e%20PHP/18%20-%20CRUD/ativa.php?usuario=".$_GET['usuario']."'>Clique aqui pra confirmar sua conta no Sistema de Cadastro de Clientes</a>";
    ...
    if($envia){
        ...
        $_SESSION['email'] = "ERRO:".$Mailer->ErrorInfo."  <a href='http://localhost/celkePHP/02%20-%20MySQLi%20e%20PHP/18%20-%20CRUD/email.php?usuario=".$_GET['usuario']."'>Clique aqui pra reenviar email.</a>";
        header("Location: index.php");
